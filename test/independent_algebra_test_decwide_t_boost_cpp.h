...
///////////////////////////////////////////////////////////////////
  ...
  template<const std::int32_t MyDigitsBase10, typename LimbType, typename AllocatorType, typename InternalFloatType, typename ExponentType, typename FftFloatType>
  auto eval_add(      independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& result,
                const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& a,
                const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& b) -> void
  {
    result.my_cpp_boost_float = a.my_cpp_boost_float + b.my_cpp_boost_float;
  }

  template<const std::int32_t MyDigitsBase10, typename LimbType, typename AllocatorType, typename InternalFloatType, typename ExponentType, typename FftFloatType>
  auto eval_sub(      independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& result,
                const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& a,
                const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& b) -> void
  {
    result.my_cpp_boost_float = a.my_cpp_boost_float - b.my_cpp_boost_float;
  ...
  template<const std::int32_t MyDigitsBase10, typename LimbType, typename AllocatorType, typename InternalFloatType, typename ExponentType, typename FftFloatType>
  auto eval_mul(      independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& result,
                const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& a,
                const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& b) -> void
  {
    result.my_cpp_boost_float = a.my_cpp_boost_float * b.my_cpp_boost_float;
  ...
  template<const std::int32_t MyDigitsBase10, typename LimbType, typename AllocatorType, typename InternalFloatType, typename ExponentType, typename FftFloatType>
  auto eval_div(      independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& result,
                const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& a,
                const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& b) -> void
  {
    result.my_cpp_boost_float = a.my_cpp_boost_float / b.my_cpp_boost_float;
  ...
  template<const std::int32_t MyDigitsBase10, typename LimbType, typename AllocatorType, typename InternalFloatType, typename ExponentType, typename FftFloatType>
  auto eval_sqrt(      independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& result,
                 const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& a) -> void
  {
    result.my_cpp_boost_float = sqrt(a.my_cpp_boost_float);
  }

  template<const std::int32_t MyDigitsBase10, typename LimbType, typename AllocatorType, typename InternalFloatType, typename ExponentType, typename FftFloatType>
  auto eval_log(      independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& result,
                const independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>& a) -> void
  {
    using boost_multiprecision_type =
      typename independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>::local_float_type;

    const boost_multiprecision_type lg_a =
      independent_algebra_test_decwide_t_boost_cpp<MyDigitsBase10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>::my_log(a.my_cpp_boost_float);
