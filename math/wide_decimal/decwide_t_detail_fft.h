...
// FFT multiplication in decwide_t.
  ...
  constexpr auto template_sin_order_1(std::uint32_t num_points) -> float_type // NOLINT(readability-function-cognitive-complexity)
  {
    ...
    return
      num_points == 2UL        ? static_cast<float_type>(1.0L)                                            : // Pi / 2    : as uint64_t --> UINT64_C(0x3FF0000000000000) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 4UL        ? static_cast<float_type>(7.0710678118654752440084436210484903928484E-01L) : // Pi / 4    : as uint64_t --> UINT64_C(0x3FE6A09E667F3BCD) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 8UL        ? static_cast<float_type>(3.8268343236508977172845998403039886676134E-01L) : // Pi / 8    : as uint64_t --> UINT64_C(0x3FD87DE2A6AEA963) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 16UL       ? static_cast<float_type>(1.9509032201612826784828486847702224092769E-01L) : // Pi / 16   : as uint64_t --> UINT64_C(0x3FC8F8B83C69A60B) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 32UL       ? static_cast<float_type>(9.8017140329560601994195563888641845861137E-02L) : // Pi / 32   : as uint64_t --> UINT64_C(0x3FB917A6BC29B42C) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 64UL       ? static_cast<float_type>(4.9067674327418014254954976942682658314745E-02L) : // Pi / 64   : as uint64_t --> UINT64_C(0x3FA91F65F10DD814) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 128UL      ? static_cast<float_type>(2.4541228522912288031734529459282925065466E-02L) : // Pi / 128  : as uint64_t --> UINT64_C(0x3F992155F7A3667E) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL <<  8U ? static_cast<float_type>(1.2271538285719926079408261951003212140372E-02L) : // Pi / 2^8  : as uint64_t --> UINT64_C(0x3F8921D1FCDEC784) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL <<  9U ? static_cast<float_type>(6.1358846491544753596402345903725809170579E-03L) : // Pi / 2^9  : as uint64_t --> UINT64_C(0x3F7921F0FE670071) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 10U ? static_cast<float_type>(3.0679567629659762701453654909198425189446E-03L) : // Pi / 2^10 : as uint64_t --> UINT64_C(0x3F6921F8BECCA4BA) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 11U ? static_cast<float_type>(1.5339801862847656123036971502640790799549E-03L) : // Pi / 2^11 : as uint64_t --> UINT64_C(0x3F5921FAAEE6472E) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 12U ? static_cast<float_type>(7.6699031874270452693856835794857664314092E-04L) : // Pi / 2^12 : as uint64_t --> UINT64_C(0x3F4921FB2AECB360) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 13U ? static_cast<float_type>(3.8349518757139558907246168118138126339503E-04L) : // Pi / 2^13 : as uint64_t --> UINT64_C(0x3F3921FB49EE4EA6) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 14U ? static_cast<float_type>(1.9174759731070330743990956198900093346887E-04L) : // Pi / 2^14 : as uint64_t --> UINT64_C(0x3F2921FB51AEB57C) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 15U ? static_cast<float_type>(9.5873799095977345870517210976476351187066E-05L) : // Pi / 2^15 : as uint64_t --> UINT64_C(0x3F1921FB539ECF31) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 16U ? static_cast<float_type>(4.7936899603066884549003990494658872746867E-05L) : // Pi / 2^16 : as uint64_t --> UINT64_C(0x3F0921FB541AD59E) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 17U ? static_cast<float_type>(2.3968449808418218729186577165021820094761E-05L) : // Pi / 2^17 : as uint64_t --> UINT64_C(0x3EF921FB5439D73A) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 18U ? static_cast<float_type>(1.1984224905069706421521561596988984804732E-05L) : // Pi / 2^18 : as uint64_t --> UINT64_C(0x3EE921FB544197A1) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 19U ? static_cast<float_type>(5.9921124526424278428797118088908617299872E-06L) : // Pi / 2^19 : as uint64_t --> UINT64_C(0x3ED921FB544387BA) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 20U ? static_cast<float_type>(2.9960562263346607504548128083570598118252E-06L) : // Pi / 2^20 : as uint64_t --> UINT64_C(0x3EC921FB544403C1) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 21U ? static_cast<float_type>(1.4980281131690112288542788461553611206918E-06L) : // Pi / 2^21 : as uint64_t --> UINT64_C(0x3EB921FB544422C2) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 22U ? static_cast<float_type>(7.4901405658471572113049856673065563715596E-07L) : // Pi / 2^22 : as uint64_t --> UINT64_C(0x3EA921FB54442A83) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 23U ? static_cast<float_type>(3.7450702829238412390316917908463317739740E-07L) : // Pi / 2^23 : as uint64_t --> UINT64_C(0x3E9921FB54442C73) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 24U ? static_cast<float_type>(1.8725351414619534486882457659356361712045E-07L) : // Pi / 2^24 : as uint64_t --> UINT64_C(0x3E8921FB54442CEF) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 25U ? static_cast<float_type>(9.3626757073098082799067286680885620193237E-08L) : // Pi / 2^25 : as uint64_t --> UINT64_C(0x3E7921FB54442D0E) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 26U ? static_cast<float_type>(4.6813378536549092695115518138540096959504E-08L) : // Pi / 2^26 : as uint64_t --> UINT64_C(0x3E6921FB54442D16) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 27U ? static_cast<float_type>(2.3406689268274552759505493419034844037886E-08L) : // Pi / 2^27 : as uint64_t --> UINT64_C(0x3E5921FB54442D18) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 28U ? static_cast<float_type>(1.1703344634137277181246213503238103798093E-08L) : // Pi / 2^28 : as uint64_t --> UINT64_C(0x3E4921FB54442D18) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 29U ? static_cast<float_type>(5.8516723170686386908097901008341396943900E-09L) : // Pi / 2^29 : as uint64_t --> UINT64_C(0x3E3921FB54442D18) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 30U ? static_cast<float_type>(2.9258361585343193579282304690689559020176E-09L) : // Pi / 2^30 : as uint64_t --> UINT64_C(0x3E2921FB54442D18) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
      num_points == 1UL << 31U ? static_cast<float_type>(1.4629180792671596805295321618659637103743E-09L) : // Pi / 2^31 : as uint64_t --> UINT64_C(0x3E1921FB54442D18) // NOLINT(cppcoreguidelines-avoid-magic-numbers,readability-magic-numbers)
