...
// This file implements various details for decwide_t.
  ...
  public:
    static constexpr std::int32_t digits10          = MyDigitsBase10;
  ...
  template<const std::int32_t MyDigitsBase10, typename LimbType> constexpr std::int32_t decwide_t_helper<MyDigitsBase10, LimbType>::digits10;
  template<const std::int32_t MyDigitsBase10, typename LimbType> constexpr std::int32_t decwide_t_helper<MyDigitsBase10, LimbType>::digits;
  template<const std::int32_t MyDigitsBase10, typename LimbType> constexpr std::int32_t decwide_t_helper<MyDigitsBase10, LimbType>::max_digits10;
  template<const std::int32_t MyDigitsBase10, typename LimbType> constexpr std::int32_t decwide_t_helper<MyDigitsBase10, LimbType>::radix;
  template<const std::int32_t MyDigitsBase10, typename LimbType> constexpr std::int32_t decwide_t_helper<MyDigitsBase10, LimbType>::elem_number_extra;
  template<const std::int32_t MyDigitsBase10, typename LimbType> constexpr std::int32_t decwide_t_helper<MyDigitsBase10, LimbType>::elem_number;
