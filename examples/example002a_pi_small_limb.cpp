...
bool math::wide_decimal::example002a_pi_small_limb()
{
  ...
  const bool head_is_ok = std::equal(my_pi.crepresentation().cbegin(),
                                     ...
                                     math::constants::const_pi_control_head<local_limb_type, 15U>().cbegin());
  ...
  const bool tail_is_ok = std::equal(ri,
                                     ri + math::constants::const_pi_control_tail<wide_decimal_digits10, local_limb_type, 16U>().size(),
                                          math::constants::const_pi_control_tail<wide_decimal_digits10, local_limb_type, 16U>().crbegin());
