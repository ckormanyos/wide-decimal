...
#endif
{
  ...
  using local_allocator_type = util::n_slot_array_allocator<void, local_elem_number, 14U>; // NOLINT(cppcoreguidelines-avoid-magic-numbers)
  ...
  (
    { 35U, 1363U, 600U, 9596U, 3986U, 6393U, 3384U, 6404U, 1805U, 5759U, 7515U, 1828U, 7169U, 3145U, 2816U, 5976U, 1647U, 1771U, 895U, 4528U, 9092U, 8635U, 312U, 1913U, 2220U, 9780U } // NOLINT(cppcoreguidelines-avoid-magic-numbers)
  );
