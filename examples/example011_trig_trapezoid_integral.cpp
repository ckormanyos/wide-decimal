...
namespace local
{
  ...
  dec51_t sin_pade(dec51_t x)
  {
    ...
    const dec51_t top = ((((((((     + *(coef_sin_top.begin() + 8U)
                                * x2 + *(coef_sin_top.begin() + 7U))
                                * x2 + *(coef_sin_top.begin() + 6U))
                                * x2 + *(coef_sin_top.begin() + 5U))
                                * x2 + *(coef_sin_top.begin() + 4U))
                                * x2 + *(coef_sin_top.begin() + 3U))
                                * x2 + *(coef_sin_top.begin() + 2U))
                                * x2 + *(coef_sin_top.begin() + 1U))
                                * x2 + *(coef_sin_top.begin() + 0U));

    const dec51_t bot = ((((((((     + *(coef_sin_bot.begin() + 8U)
                                * x2 + *(coef_sin_bot.begin() + 7U))
                                * x2 + *(coef_sin_bot.begin() + 6U))
                                * x2 + *(coef_sin_bot.begin() + 5U))
                                * x2 + *(coef_sin_bot.begin() + 4U))
                                * x2 + *(coef_sin_bot.begin() + 3U))
                                * x2 + *(coef_sin_bot.begin() + 2U))
                                * x2 + *(coef_sin_bot.begin() + 1U))
                                * x2 + *(coef_sin_bot.begin() + 0U));
  ...
  dec51_t cos_pade(dec51_t x)
  {
    ...
    {
      dec51_t( { 23373395UL, 44524486UL, 17511531UL,  2364553UL, 34935777UL, 68960000UL }, 40U ),
      dec51_t( {   259704UL, 19844314UL, 80162554UL, 61487226UL, 73292262UL,  9280000UL }, 40U ),
      dec51_t( {     1453UL, 42386551UL,  2083704UL, 44798380UL, 76079290UL, 78272000UL }, 40U ),
      dec51_t( {        5UL, 40151135UL, 19445709UL, 76526889UL, 92606084UL, 96384000UL }, 40U ),
      dec51_t( {              1473644UL, 42364155UL,  6677632UL, 34661531UL, 42457600UL }, 32U ),
      dec51_t( {                 3059UL, 38843489UL, 98650196UL, 32416479UL, 84009600UL }, 32U ),
      dec51_t( {                    4UL, 78745282UL, 53390421UL, 59067765UL, 62810080UL }, 32U ),
      dec51_t( {                           524970UL, 22782648UL, 79571778UL, 63426960UL }, 24U ),
      dec51_t( {                              315UL,  7177895UL,  8558851UL, 68016323UL }, 24U )
    };

    const dec51_t x2(x * x);

    const dec51_t top =  (((((((     + *(coef_cos_top.begin() + 7U)
                                * x2 + *(coef_cos_top.begin() + 6U))
                                * x2 + *(coef_cos_top.begin() + 5U))
                                * x2 + *(coef_cos_top.begin() + 4U))
                                * x2 + *(coef_cos_top.begin() + 3U))
                                * x2 + *(coef_cos_top.begin() + 2U))
                                * x2 + *(coef_cos_top.begin() + 1U))
                                * x2 + *(coef_cos_top.begin() + 0U));

    const dec51_t bot = ((((((((     + *(coef_cos_bot.begin() + 8U)
                                * x2 + *(coef_cos_bot.begin() + 7U))
                                * x2 + *(coef_cos_bot.begin() + 6U))
                                * x2 + *(coef_cos_bot.begin() + 5U))
                                * x2 + *(coef_cos_bot.begin() + 4U))
                                * x2 + *(coef_cos_bot.begin() + 3U))
                                * x2 + *(coef_cos_bot.begin() + 2U))
                                * x2 + *(coef_cos_bot.begin() + 1U))
                                * x2 + *(coef_cos_bot.begin() + 0U));
