...
///////////////////////////////////////////////////////////////////
  ...
  struct precision<::WIDE_DECIMAL_NAMESPACE::math::wide_decimal::decwide_t<MY_DIGITS10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>, ThisPolicy>
  #else
  struct precision<::math::wide_decimal::decwide_t<MY_DIGITS10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>, ThisPolicy>
  #endif
  {
    #if defined(WIDE_DECIMAL_NAMESPACE)
  ...
  template<const std::int32_t MY_DIGITS10,
           ...
           typename FftFloatType>
  #if defined(WIDE_DECIMAL_NAMESPACE)
  struct constant_pi<::WIDE_DECIMAL_NAMESPACE::math::wide_decimal::decwide_t<MY_DIGITS10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>>
  #else
  struct constant_pi<::math::wide_decimal::decwide_t<MY_DIGITS10, LimbType, AllocatorType, InternalFloatType, ExponentType, FftFloatType>>
  #endif
  {
  public:
    #if defined(WIDE_DECIMAL_NAMESPACE)
  ...
  template<const std::int32_t MY_DIGITS10,
           ...
           typename Policy>
  #if defined(WIDE_DECIMAL_NAMESPACE)
  struct lanczos<::WIDE_DECIMAL_NAMESPACE::math::wide_decimal::decwide_t<MY_DIGITS10,
  #else
  struct lanczos<::math::wide_decimal::decwide_t<MY_DIGITS10,
  #endif
                                                 LimbType,
                                                 AllocatorType,
                                                 InternalFloatType,
                 ...
                 Policy>
  {
    using local_backend_type =
      #if defined(WIDE_DECIMAL_NAMESPACE)
      ::WIDE_DECIMAL_NAMESPACE::math::wide_decimal::decwide_t<MY_DIGITS10,
      #else
      ::math::wide_decimal::decwide_t<MY_DIGITS10,
      #endif
                                      LimbType,
                                      AllocatorType,
                                      InternalFloatType,
