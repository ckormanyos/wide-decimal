...
## The examples
  ...
  - ![`example011_trig_trapezoid_integral`](./examples/example011_trig_trapezoid_integral.cpp) performs a trapezoid integration method using trigonometric functions to compute a cylindrical Bessel function value.
